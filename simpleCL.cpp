...
simpleCL::simpleCL() {
	queryPlatformAndDeviceCallFlg = 0;
	FILE *file;
	file = fopen("settings\\win\\device.cls", "r");
	if (file == NULL) {
		queryPlatformAndDevice();
		queryPlatformAndDeviceInfo();
		printPlatformAndDeviceInfo();
		printf("Choose the platform you want to use.\n");
	}
}
...
void simpleCL::queryPlatformAndDevice()
{
...
void simpleCL::queryPlatformAndDeviceInfo() {
...
void simpleCL::printPlatformAndDeviceInfo() {
